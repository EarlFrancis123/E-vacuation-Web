...
<sx:head />
 ...
 <s:form>
      ...
      <div class="input-group-btn"  style="margin-left: 5%;">
        <s:url var="deleteEvacuee" action="DeleteEvacuee" namespace="/evacuee/delete">
                            <s:param name="idevacuee" value="idevacuee" />
                        </s:url>
                        
   <div class="input-group-btn">
        <s:a href="%{deleteEvacuee}" class="btn btn-danger"  onclick="return confirm('Are you sure you want to delete posted quest?')"><i >Delete</i></s:a> 
      </div>
      </div>
