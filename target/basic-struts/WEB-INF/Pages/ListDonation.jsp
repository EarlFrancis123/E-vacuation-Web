...
<sx:head />
  ...
  <div class="input-group" style="margin-left: 80%;">
    <s:form>
         <div class="input-group-btn">
           <s:submit value="Update" class="btn btn-success"  style="  margin-right: 35%;" />
         </div>
       </s:form>
       <div class="input-group-btn"  style="margin-left: 5%;">
        <s:url var="deleteDonation" action="DeleteDonation" namespace="/donation/delete">
                            <s:param name="idDonations" value="idDonations" />
                        </s:url>
                        
   <div class="input-group-btn">
        <s:a href="%{deleteDonation}" class="btn btn-danger"  onclick="return confirm('Are you sure you want to delete posted quest?')"><i >Delete</i></s:a> 
      </div>
      </div>
       </div>
       </div>
